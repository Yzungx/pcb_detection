...
#---------------------------------------------------
calib_data_path = "./calib/calib_data"
...
#--------------------------------------------------------------
CHECK_DIR = os.path.isdir("./calib/ChessboardCorners/")

if not CHECK_DIR:
    os.makedirs("./calib/ChessboardCorners/")
...
for file in files:
    ...
    if ret == True:
        ...
        #cv.imwrite ( "./calib/ChessboardCorners/"+str(file) , img)
